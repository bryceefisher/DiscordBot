    ...
    class Program
    {
        ...
        public async Task HandleCommandAsync(SocketMessage arg)
        {
            ...
            if (message.HasStringPrefix("!", ref argPos))
            {
                ...
                Console.WriteLine("Command: " + message.ToString());
            }
            ...
            if (text == "/create log")
            {
                ...
                await newChannel.AddPermissionOverwriteAsync(guild.GetRole(1054560611813556238),
                    OverwritePermissions.AllowAll(newChannel));
                ...
                await newChannel.AddPermissionOverwriteAsync(guild.GetRole(1054560611813556238),
                    OverwritePermissions.DenyAll(newChannel).Modify(viewChannel: PermValue.Allow,
                ...
                await newChannel.AddPermissionOverwriteAsync(guild.EveryoneRole,
                    OverwritePermissions.DenyAll(newChannel));
            ...
            if (channel != null)
            {
                await channel.SendMessageAsync("-------------\nUser:  " + message.Author.Username + " with ID  " +
                                               message.Author.Id + "Write:" + message.ToString());
            }
            ...
            if (text.Contains("bad word") || message.Content.ToLower().Contains("badword"))
            {
            ...
            if (text.Contains("bot write me in private"))
            {
                ...
                ulong userID = 590691660724437013;
